...
public class GenerateMybatisPlus {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername("sprider2");
        dsc.setPassword("o0w6d^8GJEbU^XZF4um*UvsF$yJ9Zw");


//        #      url: jdbc:mysql://127.0.0.1:3306/spider?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai
//#      username: root
//#      password: 123456
//        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/spider?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai");
//        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
...
//        dsc.setPassword("123456");
        ...
        pc.setParent("com.jin10.spider.modules." + model);
        ...
        // 自定义配置会被优先输出
        String modelPath = "/src/main/resources/mapper/" + model;
        focList.add(new FileOutConfig(templatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + modelPath + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
         ...
         * 清除mapper下多余的xml生成目录
         */
        String xmlPath = projectPath + modelPath + "/mapper/xml";
